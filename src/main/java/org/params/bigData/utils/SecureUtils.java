...
public class SecureUtils {
    ...
    public static class DesUtil {
        ...
        public static String encrypt(String data, String iv) {
            try {
                ...
                return URLEncoder.encode(Base64.getEncoder().encodeToString(cipher.doFinal(data.getBytes())), StandardCharsets.UTF_8.toString());
        ...
        public static String decrypt(String data, String iv) {
            try {
                ...
                try {
                    return new String(cipher.doFinal(Base64.getDecoder().decode(URLDecoder.decode(data, StandardCharsets.UTF_8.toString()))));
                } catch (UnsupportedEncodingException e) {
                    throw new RuntimeException(e);
                }
            } catch (NoSuchAlgorithmException | NoSuchPaddingException | InvalidKeyException |
    ...
    public static class AesUtil {
        ...
        public static String AesEncode(String content, String password) {
            ...
            throw new RuntimeException("加密出现问题！");
        }
